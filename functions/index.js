...
module.exports = {
  ...
  twiliohook: functions.https.onRequest((req, res) => {
    ...
    AddRequest(req.body.message, req.body.from, req.body.list, req.body.url);
  })
};
